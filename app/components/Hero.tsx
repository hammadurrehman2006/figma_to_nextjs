...
<div>
  ...
  <span className="block mb-3">Hi, I am John,</span> Creative Technologist
        ...
        <p className="mb-6 mt-5 leading-relaxed text-sm sm:text-base md:text-md">
        ...
        <Link href={""}><button
          className={`${heebo.className} w-[205px] h-[50px] rounded-[2px] font-[500] mt-3 leading-[26.44px] shadow-buttonShad hover:shadow-none bg-button text-center text-white`}
        >Download Resume</button></Link>
        </div>
      </div>
      <div className="lg:max-w-lg lg:w-full w-full sm:w-1/2 lg:mr-16 relative">
  <Image
    width={292}
    height={300}
